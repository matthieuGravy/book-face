  ...
  return (
    <div className="navbar bg-gradient-to-r from-slate-100 via-stone-300 to-zink-500">
      ...
      <div className="flex-none gap-2">
        ...
        <Link to="/home">
          <button className="bg-gray-950 rounded btn text-gray-200">Home <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
